...
%---------------------------------------------------------
  \cventry
    ...
    {\href{http://genome.duke.edu}{Duke Center for Genomic and Computational Biology - http://genome.duke.edu}} % Organization
...
%---------------------------------------------------------
  \cventry
    ...
    {\href{The Field Museum}{http://www.fieldmuseum.org/} - Zoology} % Organization
    {Chicago, Il} % Location
    {2009 - 2011} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    {System Administrator} % Job title
    {Bruce Rannala Research Group} % Organization
    {University of Alberta} % Location
    {2002 - 2003} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
